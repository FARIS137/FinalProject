    ...
    <div class="row justify-content-center">
        <div class="col-md-7 col-lg-4 mb-5 mb-lg-0 wow fadeIn">
            <div class="card border-0 shadow">
                @empty($users->foto)
                <img src="{{url('admin/image/nofoto.jpeg')}}" alt="..">
                @else
                <img src="{{url('admin/image')}}/{{$users->foto}}" alt="..">
                @endempty
                <div class="card-body p-1-9 p-xl-5">
                    <div class="mb-4">
                        <h3 class="h4 mb-0">{{$users->nama}} </h3>
                    </div>
                    <ul class="list-unstyled mb-4">
                        <li class="mb-3"><a href="#!"><i class="far fa-envelope display-25 me-3 text-secondary"></i>{{$users->email}} </a></li>
